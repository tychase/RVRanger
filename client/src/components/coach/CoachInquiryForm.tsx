...
const CoachInquiryForm = ({ rvId }: CoachInquiryFormProps) => {
  ...
  return (
    <div className="border border-neutral-200 rounded-lg p-6">
      <h3 className="text-xl font-semibold mb-4">Interested in this Coach?</h3>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea 
                    placeholder="I'm interested in this Coach and would like more information..." 
                    rows={4}
                    {...field} 
                  />
                </FormControl>
...
export default CoachInquiryForm;