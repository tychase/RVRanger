...
const FeaturedListings = () => {
  const { data: featuredCoaches, isLoading, error } = useQuery<Coach[]>({
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-neutral-light">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 md:mb-12">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-neutral-dark mb-4 md:mb-0 font-serif tracking-wider text-center md:text-left">
            Featured Luxury Coaches
          </h2>
          <Link href="/browse?featured=true" className="group flex items-center text-primary font-medium tracking-wide text-sm sm:text-base">
